...
* [Obsidian Notes Watcher](https://github.com/britt/obsidian-notes-watcher) - watch an Obsidian vault and update notes when files change.
* [LLPM](https://github.com/britt/llpm) - manage prompt libraries for language models from the command line.
