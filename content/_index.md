...
* [Obsidian Notes Watcher](https://github.com/britt/obsidian-notes-watcher) - keeps an Obsidian vault in sync with the local file system.
* [LLPM](https://github.com/britt/llpm) - a command line tool for prompt library management.
