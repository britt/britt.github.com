...
* [Obsidian Notes Watcher](https://github.com/britt/obsidian-notes-watcher) - A tool that watches Git-backed Obsidian notes for @mentions and dispatches agents like Claude Code to edit, reorganize, and commit changes back to the vault.
* [LLPM](https://github.com/britt/llpm) - A modern AI-powered project management CLI that brings natural-language organization, GitHub integration, and persistent workspace configuration to the terminal.
