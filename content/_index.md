...
11 * Claude Code Skills - an open collection of reusable Claude Code skills, each described in a `CLAUDE.md` file and published on a catalog site that groups related skills under clear, task-focused category headings so it is easy to see what skills exist in each area.
